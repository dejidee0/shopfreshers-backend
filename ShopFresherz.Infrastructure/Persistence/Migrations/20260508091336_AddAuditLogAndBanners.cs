...
{
    /// <inheritdoc />
    public partial class AddAuditLogAndBanners : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CtaText = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomepageBanners_IsActive_SortOrder",
