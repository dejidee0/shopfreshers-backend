...
public class Order : BaseEntity
{
    ...
    /// <summary>Gets or sets the Flutterwave transaction reference.</summary>
    public string? PaymentReference { get; set; }

    /// <summary>
    /// Gets or sets the Flutterwave inline-popup transaction reference
    /// ("TXN-{orderId}-{unixSeconds}") generated by the two-step checkout flow.
    /// </summary>
